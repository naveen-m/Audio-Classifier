...
public class OuterFrame extends JFrame {
	...
	public OuterFrame(Controller c) {
		...
		// Set window title
		setTitle("Audio Classifier - jAduio & Weka ");
...
//		helpTopics.addActionListener(new CSH.DisplayHelpFromSource(hb));
		...
		/* Commented out the not needed menus*/
		//menu.add(fileMenu);
		//menu.add(editMenu);
		...
		feature_selector_panel.setBounds(800,200, 75, 20);		
		
		//recording_selector_panel.add(feature_selector_panel);
